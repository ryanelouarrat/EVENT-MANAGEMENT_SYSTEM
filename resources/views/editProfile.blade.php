...
<body>
    ...
    <div class="profile row" style="margin:auto !important;">
        <div class="sidebar col-2">
            ...
            <div class="sidebar-content">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="{{ route('updateProfile', ['user' => auth()->user()->id]) }}">Edit Profile</a>
                  </li>
        ...
        <div class="col mainco">
            <h1>Main Content</h1>
            <form action="/EditProfile{{ auth()->user()->id }}" method="POST" class="row g-3"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="ClubName" id="ClubName"
                        value="{{ old('ClubName', auth()->user()->ClubName) }}">
                    @error('ClubName')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="Categorie" id="categorie">
                        <option value="club" {{ old('Categorie', auth()->user()->Categorie) == 'club' ? 'selected' : ''
                            }}>Club</option>
                        <option value="directions" {{ old('Categorie', auth()->user()->Categorie) == 'directions' ?
                            'selected' : '' }}>Directions</option>
                        <option value="professeur" {{ old('Categorie', auth()->user()->Categorie) == 'professeur' ?
                            'selected' : '' }}>Professeur</option>
                        <option value="autre" {{ old('Categorie', auth()->user()->Categorie) == 'autre' ? 'selected' :
                            '' }}>Autre</option>
                    </select>
                    @error('Categorie')
                    <span class="text-danger">{{ $message }}</span>
